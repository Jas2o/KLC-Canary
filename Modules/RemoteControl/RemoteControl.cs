...
namespace KLC_Finch {
    ...
    public class RemoteControl : IRemoteControl {
        ...
        public void Connect() {
            ...
            ConnectionManager.Active.LCSession.ModuleRemoteControl.ConnectV1(App.winStandaloneViewer);
            return;

            /*
            if (ViewerWindow != null) { //Only for reconnect
                ViewerWindow.Close();
                ViewerWindow = null;
            }
            */
            ...
            //App.viewer = 
            /*
            ViewerWindow = new WindowViewerV3(App.Settings.Renderer, this, session.agent.OSTypeProfile, session.agent.UserLast);
            ViewerWindow.SetTitle(session.agent.Name, mode);
            ViewerWindow.SetApprovalAndSpecialNote(session.RCNotify, session.agent.MachineShowToolTip, session.agent.MachineNote, session.agent.MachineNoteLink);
            ViewerWindow.Show();
            */
        ...
        public void ConnectV2(WindowCharm winCharm)
        {
        ...
        public void Reconnect() {
            if (App.winStandaloneViewer != null)
            {
                ...
                WindowState tempState = App.winStandaloneViewer.WindowState;
                App.winStandaloneViewer.WindowState = WindowState.Normal;
                int tempLeft = (int)App.winStandaloneViewer.Left;
                int tempTop = (int)App.winStandaloneViewer.Top;
                ...
                App.winStandaloneViewer.Top = tempTop;
                App.winStandaloneViewer.Width = tempWidth;
                App.winStandaloneViewer.Height = tempHeight;
